...
public class TooltipPopup : MonoBehaviour
{
    ...
    private void FollowCursor()
    {
        ...
        float topEdgeToScreenEdgeDistance = Screen.height - (newPos.y + popupObject.rect.height * popupCanvas.scaleFactor / 2) - padding;
    ...
    public void DisplayInfo (IHasTooltip tooltip)
    {
        StringBuilder builder = new StringBuilder();
        builder.Append(tooltip.GetTooltipInfoText());
